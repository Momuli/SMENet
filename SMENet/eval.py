...
parser.add_argument('--trained_model',
                    default='weights/SMENet.pth', type=str,
...
def do_python_eval(output_dir='output', use_07=True):
    ...
    for i, cls in enumerate(labelmap):
        ...
        imgsetpathss = '/media/newamax/94d146aa-e21d-4f2d-ae9d-1f54448708202/lina/SMENet/VOCNWPU/VOC2012/ImageSets/Main/test.txt'
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir('SMENet', set_type)
    ...
    for i in range(num_images):
        ...
        for j in range(1, detections.size(1)):
            ...
            mask = dets[:, 0].gt(0.).expand(5, dets.size(0)).t()   # dets[:, 0] is score
...
if __name__ == '__main__':
    ...
    for iter in range(1):
        weights_path = 'weights/SMENet.pth'
        ...
        mAP = test_net(args.save_folder, net, args.cuda, dataset,
                 BaseTransform(net.size, dataset_mean), args.top_k, 400,
